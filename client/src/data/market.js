...
export const PLANS = [
  ...
  },
  {
    ...
    features: [
      ...
      'Detailed news feed and sentiment analysis',
    ],
  },
  {
    id: 'pro',
    ...
    color: '#00e676',
    features: [
      'Everything in Bronco Basic and Bronco+',
      'Robust alert system and Pro signal factors',
      '$250,000 daily EFT deposit limit',
      'Advanced news feed with summary and sentiment analysis',

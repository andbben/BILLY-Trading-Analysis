...
export const PLANS = [
  {
    ...
    color: '#00e676',
    features: [
      'One primary watchlist',
      'Price alerts',
      '$10,000 daily EFT deposit limit',
      'Basic article view: headline, source, key points, and market impact',
    ],
    locked: ['News sentiment alerts', 'Technical alerts', 'Signal factors', 'Billy Analyst automation'],
  },
  {
    id: 'plus',
    name: 'Bronco Plus',
    ...
    features: [
      ...
      '$75,000 daily EFT deposit limit',
      'News sentiment labels with Bullish, Bearish, and Neutral analysis',
    ],
    locked: ['Technical alerts', 'Signal factors', 'Billy Analyst automation'],
  },
  {
    id: 'pro',
    name: 'Bronco Pro',
    ...
    features: [
      'Everything in Plus',
      'Technical alerts and Pro signal factors',
      '$250,000 daily EFT deposit limit',
      'Full article analysis with summary, impact, key points, watch-for details, and sentiment',
      'Billy Analyst automated trading access',
    ],
  },
];
